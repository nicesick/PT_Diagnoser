...
--QUESTION INSERT
insert into question (category, content, use_yn ) values ('s',	'도입부에서 청중의 주의를 끄는가?        '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'태도는 겸손하게 진행 하는가?          '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'주제를 분명히 소개 하는가?            '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'내용이 논리적이고 일관성이 있는가?       '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'핵심 주제와 소주제를 명확히 밝히는가?     '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'내용 구성이 분명한가?               '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'실례, 근거자료 등을 활용하여 설명하는가?  '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'스피치에 열의와 자신감이 넘치는가?       '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'2개 이상의 인용된 지지 자료가 있는가?    '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'적절한 지지 자료를 사용했는가?         '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'논점을 분명히 요약하는가?             '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'강조된 끝맺음을 하는가?              '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'청중을 골고루 살피는 시선 처리를 하는가?  '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'제스처가 자연스러운가?               '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'차분하고 안정된 스피치 상태인가?        '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'표정은 편안하게 또는 미소 짓고 있는가?    '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'분명하게 발음하는가?                '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'목소리의 크기는 적절한가?             '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'말의 속도는 적절한가?	Y             ' ,'Y');
insert into question (category, content, use_yn ) values ('s',	'음성적 군말 (어,저 등)을 사용하지 않는가? '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'적절히 호흡을 하고 쉬는가?            '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'목소리에 적절한 고저가 있는가?         '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'목소리에 강약이 있는가?              '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'준비는 충분하였는가?                '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'자신이 준비한 내용을 100% 전달하였는가?  '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'스피치의 취지에 합당하는가?           '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'스피치 내용이 청중에게 적절한가?        '	,'Y');
insert into question (category, content, use_yn ) values ('s',	'정해진 시간 안에 끝내는가             '	,'Y');
